...
frontend_server_config = {
    ...
    "environment": {
        ...
        "googleClientId": env_manager.get_env("GOOGLE_CLIENT_ID"),
        "googleSecretId": env_manager.get_env("GOOGLE_CLIENT_SECRET"),
        "facebookClientId": env_manager.get_env("FACEBOOK_CLIENT_ID"),
        "facebookSecretId": env_manager.get_env("FACEBOOK_CLIENT_SECRET"),
